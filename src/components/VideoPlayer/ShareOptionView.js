...
const shareOptions = [{
  imageRef: require('./image/icon_share_qq.png'),
  title: 'QQ',
}, {
  imageRef: require('./image/icon_share_qzone.png'),
  title: 'QQ空间',
}, {
  imageRef: require('./image/icon_share_wxsession.png'),
  title: '微信',
}, {
  imageRef: require('./image/icon_share_wxtimeline.png'),
  title: '朋友圈',
}, {
  imageRef: require('./image/icon_share_sina.png'),
  title: '微博',
}, {
  imageRef: require('./image/icon_share_copylink.png'),
  title: '复制链接',
}, ];
