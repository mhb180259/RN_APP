                ...
                this.state.isPlaying ? null :
                  <TouchableWithoutFeedback onPress={() => { this.onPressPlayButton() }}>
                    <Image
                      ...
                      source={require('../../components/VideoPlayer/img/play.png')}
                    />
                  </TouchableWithoutFeedback>
              }
            </View>
              ...
              <View style={[styles.control, {width: this.state.videoWidth}]}>
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlPlayPress() }}>
                  <Image
                    ...
                    source={this.state.isPlaying ? require('../../components/VideoPlayer/img/play.png') : require('../../components/VideoPlayer/img/play.png')}
                  />
                </TouchableOpacity>
                ...
                <Slider
                  ...
                  thumbImage={require('../../components/VideoPlayer/img/play.png')}
                ...
                <TouchableOpacity activeOpacity={0.3} onPress={() => { this.onControlShrinkPress() }}>
                  <Image
                    ...
                    source={this.state.isFullScreen ? require('../../components/VideoPlayer/img/play.png') : require('../../components/VideoPlayer/img/play.png')}
                  />
                </TouchableOpacity>
              </View> : null
          }
